# R6R3 Source Lineage Authentication R2
...
1. **Design-source provenance** identifies the R2 package documents and their
...
references. R2 deliberately does not pin or invent a replacement commit. Its
