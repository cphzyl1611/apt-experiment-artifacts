...
class B3HumanTerminalRegressionTests(unittest.TestCase):
    ...
    def test_three_human_actions_and_owner_terminal_paths_are_mechanical(self):
        ...
        self.assertTrue(contract.validate_human_packet(packet))
        for action in ("CONFIRM_PROPOSED_OWNER", "REJECT_PROPOSAL_AND_SELECT_OTHER_EXISTING_CANDIDATE", "NOT_SURE_ESCALATE"):
            ...
            self.assertTrue(contract.validate_human_decision(packet, decision))
...
class B4SchemaDispositionRegressionTests(unittest.TestCase):
    ...
    def test_disposition_lineage_required_fields_and_remediation_reference(self):
        ...
        self.assertTrue(contract.validate_disposition_record(record))
    ...
    def test_owner_confirm_and_reject_paths_require_human_provenance_and_pass(self):
        ...
        self.assertTrue(contract.validate_owner_terminal(dict(base, human_action="CONFIRM_PROPOSED_OWNER", fresh_alternative_verification=None)))
        self.assertTrue(contract.validate_owner_terminal(dict(base, human_action="REJECT_PROPOSAL_AND_SELECT_OTHER_EXISTING_CANDIDATE", fresh_alternative_verification={"status": "PASS"})))
