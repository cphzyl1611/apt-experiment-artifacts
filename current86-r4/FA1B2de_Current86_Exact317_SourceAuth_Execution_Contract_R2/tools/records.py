...
EXACT_SCHEMA_NAME = {
    ...
    "primary_commitment": "FA1B2DE_CURRENT86_SOURCE_AUTH_PRIMARY_COMMITMENT_R2",
    "verifier_commitment": "FA1B2DE_CURRENT86_SOURCE_AUTH_VERIFIER_COMMITMENT_R2",
    "comparison_record": "FA1B2DE_CURRENT86_SOURCE_AUTH_COMPARISON_RECORD_R2",
    ...
    "machine_authority_expansion_record": "FA1B2DE_CURRENT86_MACHINE_AUTHORITY_EXPANSION_RECORD_R2",
    "machine_authority_evaluation_evidence": "FA1B2DE_CURRENT86_MACHINE_AUTHORITY_EVALUATION_EVIDENCE_R2",
}
...
SCHEMA_FIELDS = {
    "common_input_entry": fields("schema", "logical_artifact_id", "logical_artifact_role", "exact_locator", "sha256_or_explicit_pinned_identity", "byte_length", "media_type", "schema_or_contract_id", "provenance_id", "authority_role", "governance_freeze_record_id", "read_mode", "available", "content_opened", "content_sha256_observed", "content_byte_length_observed", "common_input_entry_id"),
    ...
    "primary_commitment": fields("schema", "role", "common_input_set_id", "implementation_id", "context_id", "run_id", "isolation_audit_id", "ordered_result_vector_sha256", "terminal_state_count_map", "exact_target_id_set_sha256", "private_output_manifest_sha256", "commitment_id"),
    "verifier_commitment": fields("schema", "role", "common_input_set_id", "implementation_id", "context_id", "run_id", "isolation_audit_id", "ordered_result_vector_sha256", "terminal_state_count_map", "exact_target_id_set_sha256", "private_output_manifest_sha256", "commitment_id"),
    ...
    "machine_authority_expansion_record": fields("schema", "audit_scope_id", "authority_record_id", "evaluation_contract_id", "complete_input_open_audit_id", "expansion_complete", "ordered_tuple_ids", "tuples", "rejected_record_reason_codes", "ordered_set_commitment_id", "expansion_record_id"),
    "machine_authority_evaluation_evidence": fields("schema", "audit_scope_id", "machine_authority_input_set_id", "evaluation_contract_id", "complete_input_open_audit", "authority_authentication_results", "deterministic_expansion_outputs", "rejected_record_reason_codes", "ordered_set_commitments", "machine_authority_evaluation_evidence_id"),
}
