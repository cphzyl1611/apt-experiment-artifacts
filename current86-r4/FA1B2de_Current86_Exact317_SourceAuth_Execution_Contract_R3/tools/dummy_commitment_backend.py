...
row = {
    ...
    "ordered_target_result_vector": [{"target_id": "synthetic-target-1", "result_commitment": "1" * 64}],
    "ordered_result_vector_sha256": digest([{"target_id": "synthetic-target-1", "result_commitment": "1" * 64}]),
