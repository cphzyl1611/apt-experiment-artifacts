...
RECORD_PATH = PACKAGE.parent / "FA1B2de_Current86_FirstTranche24_G1G2_Decision_Preparation_V2" / "FIRST_TRANCHE24_GOVERNANCE_DECISION_RECORD_V2.json"
...
class DecisionIdentityContractTests(unittest.TestCase):
    ...
    def test_zero_mutation_state_is_exactly_preserved(self):
        zero_path = PACKAGE.parent / "FA1B2de_Current86_FirstTranche24_Human_Governance_Decision_G1G2" / "ZERO_OPERATIONAL_EFFECT_RECOMPUTATION.json"
